...
export function nicknameAction (data) {
    return {
        type: NICKNAME,
        data
    }
...
export function searchConsoleOff () {
    return {
        type: SEARCH_CONSOLE_OFF,
    }
}

export function searchConsoleOn () {
    return {
        type: SEARCH_CONSOLE_ON,
    }
}